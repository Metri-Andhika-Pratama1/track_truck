        ...
        <div class="blur-container border border-primary rounded p-4">
            ...
            <form action="{{ route('supir.update', $supir->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="{{ $supir->nama }}"
                        required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="no_karyawan" name="no_karyawan"
                        value="{{ $supir->no_karyawan }}" required>
                </div>
                <div class="mb-3">
                    <label for="noHP" class="form-label">No HP</label>
                    <input type="text" class="form-control" id="noHP" name="noHP" value="{{ $supir->noHP }}"
                        required>
                </div>
                <div class="mb-3">
